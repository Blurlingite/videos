...
// We also destructured the props object coming in so that we just take the "videos" field. So instead of saying const VideoList = (props) we say const VideoList = ({videos, onVideoSelect})
